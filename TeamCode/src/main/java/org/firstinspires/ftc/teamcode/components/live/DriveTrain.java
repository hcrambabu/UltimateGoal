...
public class DriveTrain extends Component {
    ...
    public void registerHardware(HardwareMap hwmap) {
        ...
        //// MOTORS ////
        drive_lf    = hwmap.get(DcMotorEx.class, "lf");
        drive_rf    = hwmap.get(DcMotorEx.class, "rf");
        drive_lb    = hwmap.get(DcMotorEx.class, "lb");
        drive_rb    = hwmap.get(DcMotorEx.class, "rb");
    ...
    public void updateTelemetry(Telemetry telemetry) {
        ...
        telemetry.addData("X", ((int)(lcs.x*1000))/1000.0);
        telemetry.addData("Y", ((int)(lcs.y*1000))/1000.0);
        telemetry.addData("A", ((int)(lcs.a*1000))/1000.0);
    ...
    public void setZeroPowerBehavior(DcMotor.ZeroPowerBehavior b) {
        drive_lf.setZeroPowerBehavior(b);
        drive_rf.setZeroPowerBehavior(b);
        drive_lb.setZeroPowerBehavior(b);
        drive_rb.setZeroPowerBehavior(b);
    }
    ...
    public void odo_move(double x, double y, double a, double speed, double pos_acc, double angle_acc, double timeout, double time_at_target) {
        ...
        time_at_target = Math.abs(time_at_target);
        ...
        if (original_distance > 0 || original_distance_a > 0) {
            while (robot.opmode.opModeIsActive()) {
                ...
                if ((Math.abs(distance) < pos_acc && Math.abs(distance_a) < angle_acc) || (timeout > 0 && robot.opmode.getRuntime() > timeout)) {
